...
export class TicketController {
    ...
    public get_ticket_by_id = async (req: Request, res: Response) => {
        try {
            ...
            const error = err instanceof ResponseError ? err : new ResponseError(500, "Error al obtener ticket");
    ...
    public get_tickets_by_user = async (req: Request, res: Response) => {
        try {
            ...
            const error = err instanceof ResponseError ? err : new ResponseError(500, "Error al obtener tickets del usuario");
            res.status(error.statusCode).json({
                success: false,
                message: error.message
            });
    ...
    public get_my_tickets = async (req: Request, res: Response) => {
        try {
            ...
            const error = err instanceof ResponseError ? err : new ResponseError(500, "Error al obtener mis tickets");
            res.status(error.statusCode).json({
                success: false,
                message: error.message
            });
    ...
    public get_tickets_by_game = async (req: Request, res: Response) => {
        try {
            ...
            const error = err instanceof ResponseError ? err : new ResponseError(500, "Error al obtener tickets del juego");
            res.status(error.statusCode).json({
                success: false,
                message: error.message
            });
    ...
    public get_tickets_by_curva = async (req: Request, res: Response) => {
        try {
            ...
            const error = err instanceof ResponseError ? err : new ResponseError(500, "Error al obtener tickets de la curva");
            res.status(error.statusCode).json({
                success: false,
                message: error.message
            });
    ...
    public get_all_tickets = async (req: Request, res: Response) => {
        try {
            ...
            const error = err instanceof ResponseError ? err : new ResponseError(500, "Error al obtener todos los tickets");
            res.status(error.statusCode).json({
                success: false,
                message: error.message
            });
    ...
    public create_ticket = async (req: Request, res: Response) => {
        try {
            ...
            const error = err instanceof ResponseError ? err : new ResponseError(500, "Error al crear ticket");
            res.status(error.statusCode).json({
                success: false,
                message: error.message
            });
    ...
    public change_ticket_status = async (req: Request, res: Response) => {
        try {
            ...
            const error = err instanceof ResponseError ? err : new ResponseError(500, "Error al cambiar estado del ticket");
            res.status(error.statusCode).json({
                success: false,
                message: error.message
            });
